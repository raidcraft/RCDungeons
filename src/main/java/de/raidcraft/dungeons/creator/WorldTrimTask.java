...
public class WorldTrimTask implements Runnable {
    ...
    private transient Set<CoordXZ> keptChunks;
    private transient boolean readyToGo = false;
    private transient boolean paused = false;
    private transient int taskID = -1;
    private transient Player notifyPlayer = null;
    private transient int chunksPerRun = 25;
    ...
    public WorldTrimTask(Server theServer, Player player, World world, Set<CoordXZ> chunks) {

        this.server = theServer;
        this.notifyPlayer = player;
        this.world = world;
        this.keptChunks = chunks;
    ...
    private boolean isChunkInsideBorder(CoordXZ chunk) {
        ...
        return keptChunks.contains(chunk);
    }
    ...
    private void reportProgress() {
        ...
        sendMessage(reportTrimmedRegions + " entire region(s) and " + reportTrimmedChunks + " individual chunk(s) trimmed so far (" + perc + "% done" + ")");
    }
